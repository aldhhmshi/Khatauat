...
final class BillingService
{
    ...
    public function createPendingOrder(int $userId, string $productCode, bool $termsAccepted, bool $privacyAccepted): array
    {
