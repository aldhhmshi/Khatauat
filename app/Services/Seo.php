...
final class Seo
{
    ...
    /* KHATAUAT_SERVICE_SCHEMA_V1 */
    public static function serviceJsonLd(array $service): string
    {
        ...
        $description = trim(
            (string)($service['seo_description'] ?? '')
        );
        ...
        /*
         * الجهة الرسمية مقدمة للخدمة عندما تكون
         * البيانات محددة في سجل الخدمة.
         */
        if ($officialEntity !== '') {
            $provider = [
                '@type' => 'Organization',
