...
final class ServiceController
{
    ...
    public function show(string $slug): void
    {
        ...
        View::render('services/show', compact('service','steps','sources','changes','questions','breadcrumbs','isFollowed') + ['title'=>$service['seo_title'] ?: $service['name'], 'metaDescription'=>$service['seo_description'] ?: $service['summary']]);
    }
