...
// Khatauat v1.4.4 navigation-state fallback + safe UI additions
(()=>{
...
// Khatauat 2.0 Journey OS interactions
(()=>{
...
// Khatauat v2.0.15 — owner console navigation
(()=>{
...
// Khatauat v2.0.14 — approve source in-place without jumping to page top
(()=>{
...
// Khatauat v2.0.15 — grouped settings navigation + safe return position
(()=>{
...
// Khatauat v2.0.16 — branded opening + unified subtle reveal
(()=>{
