...
<?php
$ownerLogoPath = trim((string)\Khatauat\Core\Settings::get('site_logo_path', ''));
$ownerSiteName = trim((string)\Khatauat\Core\Settings::get('site_name', 'خطوات'));
?>
<?php if ($ownerLogoPath !== ''): ?>
<span class="owner-brand-mark v216-owner-mark has-image">
    <img
        src="<?= e(url($ownerLogoPath)) ?>"
        alt="<?= e($ownerSiteName) ?>"
        width="42"
        height="42"
        loading="eager"
...
<?php else: ?>
<span class="owner-brand-mark v216-owner-mark" aria-hidden="true"><i></i><i></i><i></i><i></i></span>
<?php endif; ?>
