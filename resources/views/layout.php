...
$seoStatic = [
    ...
    '/contact' => [
        'title' =>
            'تواصل مع منصة خطوات | الاستفسارات والملاحظات',
        'description' =>
...
<head>
<?php /* KHATAUAT_ADSENSE_V1 */ ?>
<?php if (!$isOwnerConsole): ?>
<script async
    src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5848578037602912"
