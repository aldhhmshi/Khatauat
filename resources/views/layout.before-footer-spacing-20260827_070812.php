...
$seoStatic = [
    ...
    '/calculators' => [
        'title' =>
            'الحاسبات والأدوات الرقمية | خطوات',
        'description' =>
            'استخدم حاسبات وأدوات رقمية تساعدك على تقدير الرسوم والمتطلبات وفهم الإجراءات قبل البدء في تنفيذ الخدمة.',
    ],
...
<link rel="stylesheet" href="<?= e(asset('css/app.css')) ?>?v=221">
